          ...
          >
            ...
            <div className="space-y-6 border-b border-purple-500/20 pb-12">
              ...
              <p className="text-xl text-gray-300 font-light max-w-2xl leading-relaxed">
                We are planning an exciting lineup of hackathons, workshops, and community gatherings designed to bring developers together and foster collaboration and growth.
              </p>
            </div>
            ...
            >
              <div className="space-y-4">
                <p className="text-gray-400 text-lg">
                  Event announcements and registration details coming soon.
                </p>
                <motion.a
